    ...
    protected function getTableQuery(): Builder
    {
        ...
        if ($user && !$user->hasRole('Super Admin')) {
            $query->where(function (Builder $q) use ($user) {
                $q->whereIn('status', [
                    ...
                    $subq->where('status', Pengajuan::STATUS_MENUNGGU_PELUNASAN)
                        ->whereNotNull('direktur_operasional_id')
                        ->where('direktur_operasional_id', $user->id);
                })->orWhere('direktur_operasional_id', $user->id);
            });
        } else {
            $query->where(function (Builder $q) {
                ...
                ])->orWhereNotNull('direktur_operasional_id');
            });
        }
        ...
        return [
            ...
            TextColumn::make('tindakan_saya')
                ...
                ->state(function (Pengajuan $record): string {
                    if ($record->direktur_operasional_id === Auth::id()) {
            ...
            Action::make('buat_keputusan')
                ...
                ->action(function (array $data, Pengajuan $record) {
                    if ($data['direktur_operasional_decision_type'] === 'Disetujui') {
                        ...
                        $record->update([
                            'status' => $newStatus,
                            'direktur_operasional_id' => Auth::id(),
            ...
            Action::make('process_revisi_decision_dir_ops')
                ...
                ->action(function (array $data, Pengajuan $record) {
                    ...
                    $latestRevisi->update([
                        ...
                        'revisi_direktur_operasional_id' => Auth::id(),
                    ]);
