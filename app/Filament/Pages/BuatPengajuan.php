...
class BuatPengajuan extends Page implements HasForms
{
    ...
    private function generateKodePengajuan(): string
    {
        ...
        $todayCount = Pengajuan::where('pemohon_id', $user->id)
                    ...
                    Wizard\Step::make('Detail Pengajuan')
                        ->schema([
                            Grid::make(3)->schema([
                                ...
                                Select::make('pemohon_id')->label('Pemohon')->options(User::all()->pluck('nama_user', 'id'))->disabled()->required(),
