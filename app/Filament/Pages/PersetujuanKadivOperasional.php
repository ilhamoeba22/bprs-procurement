        ...
        return [
            ...
            TextColumn::make('tindakan_saya')
                ...
                ->state(function (Pengajuan $record): string {
                    ...
                    if ($record->kadiv_ops_id === Auth::id()) {
        ...
        return [
            ...
            Action::make('process_final_decision')
                ...
                ->action(function (array $data, Pengajuan $record) {
                    ...
                    // Tandai vendor final
                    VendorPembayaran::where('pengajuan_id', $record->id)->update(['is_final' => false]);
                    VendorPembayaran::where('pengajuan_id', $record->id)
