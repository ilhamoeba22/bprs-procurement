    ...
    public static function make(): array
    {
        return [
            Section::make('Detail Pengajuan')->schema([
                ...
                Grid::make(2)->schema([
                    ...
                    Textarea::make('rekomendasi_it_catatan')
                        ...
                        ->disabled(),
                ])->visible(fn(Pengajuan $record) => !is_null($record->it_id)),
            ...
            Section::make('Hasil Survei Harga GA')->schema([
                ...
                ->visible(fn(Pengajuan $record) => !is_null($record->ga_id))
                ->collapsible()->collapsed(),
            ...
            ])->visible(fn(Pengajuan $record) => !is_null($record->kadiv_ga_id))->collapsible()->collapsed(),
            ...
            Section::make('Budget Control')
                ...
                ->visible(fn(Pengajuan $record) => !is_null($record->budget_id)),
            ...
            Section::make('Final Approve')
                ->schema([
                    ...
                    ])->visible(fn(Pengajuan $record) => !is_null($record->dirop_id)),
                    Grid::make(2)->schema([
                    ...
                    ])->visible(fn(Pengajuan $record) => !is_null($record->dirut_id)),
                ])
