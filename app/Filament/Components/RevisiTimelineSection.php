            ...
            ->schema([
                ...
                Section::make('Persetujuan Final (Revisi)')
                    ->schema([
                        ...
                        // Grid untuk Keputusan Kadiv Operasional
                        Grid::make(3)->schema([
                            TextInput::make('revisi_kadiv_ops_decision_type')->label('Keputusan Kadiv Operasional')->disabled(),
                            Textarea::make('revisi_kadiv_ops_catatan')->label('Catatan Revisi')->disabled(),
                            TextInput::make('revisi_kadiv_ops_approver_name')->label('Diberikan Oleh')->disabled(),
                        ])->visible(fn($get) => !empty($get('revisi_kadiv_ops_decision_type'))),
